...
public interface MediaType {
     ...
     * json格式
     */
//    okhttp3.MediaType MEDIA_TYPE_JSON = okhttp3.MediaType.parse("application/json");
    okhttp3.MediaType MEDIA_TYPE_JSON = okhttp3.MediaType.parse("application/json; charset=utf-8");
    okhttp3.MediaType MEDIA_TYPE_FORM = okhttp3.MediaType.parse("application/x-www-form-urlencoded;charset=utf-8");
    /**
     * html格式
     */

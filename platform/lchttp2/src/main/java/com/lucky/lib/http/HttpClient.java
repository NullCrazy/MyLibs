...
import com.lucky.lib.http.dns.HttpDnsListener;
...
import static com.lucky.lib.http.HttpConfig.DEFAULT_MAX_TOTAL_CONNECTIONS;
    ...
    private OkHttpClient getOkHttpClient(final Builder innerBuilder) {
        ...
        builder.eventListenerFactory(new EventListener.Factory() {
            ...
            public EventListener create(Call call) {
                return new HttpEventListenerImpl(HttpClient.this);
            }
        });
        //增加DNS解析
